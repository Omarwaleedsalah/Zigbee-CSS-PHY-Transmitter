...
// Read memory
initial begin
    $readmemh("D:/ITI_Summer_2026/ITI Summer Project/Final_Submissionn/Codes/Scripts/My_scripts/ram_random_data.txt", DUT_RAM.mem);
end
...
task test_symbol_mapper();
    ...
    begin
        ...
        if (i_symbol_mapper_valid) begin
            $display("TIME = %0t | I_SYM_COUNT = %0d | 6-BIT_I_SYM = %b (%0d) | 32-BIT_CODEWORD = %b",
                     $time, i_sym_cnt, i_symbol, i_symbol, i_symbol_mapper_out);
            i_sym_cnt = i_sym_cnt + 1;
        end
        if (q_symbol_mapper_valid) begin
            $display("TIME = %0t | Q_SYM_COUNT = %0d | 6-BIT_Q_SYM = %b (%0d) | 32-BIT_CODEWORD = %b",
