module PPDU (clk,reset,start,total_bits,i_path_data,q_path_data,i_path_valid,q_path_valid,
            ppdu_i_out,ppdu_q_out,ppdu_valid,done);

input clk;
input reset;
input start;
input [10:0] total_bits;
input [63:0] i_path_data;
input [63:0] q_path_data;
input i_path_valid;
input q_path_valid;
