module symbol_buffer (clk,reset,sym_valid,    sym_data,  intrlv_valid,intrlv_data   );
input  clk;
input  reset;
input  sym_valid;// High when the Symbol Mapper has a valid 32-bit output
input  [31:0] sym_data; // 32-bit codeword from the Symbol Mapper
